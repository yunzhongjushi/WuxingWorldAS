package com.view.UI.challenge {
	 ...
	 * @author hunterxie
	 */
	public class ChallengeTu extends BasePanel{
		public static const NAME:String = "ChallengeTu";
		public static const SINGLETON_MSG:String="single_ChallengeTu_only";
		protected static var instance:ChallengeTu;
		public static function getInstance():ChallengeTu{
			if ( instance == null ) instance=new ChallengeTu();
			return instance as ChallengeTu;
		}
